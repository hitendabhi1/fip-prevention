<?php
/* Template Name: Vector-Borne Diseases */
/**
 * template-vector.php
...
$vector_hero = get_field( 'vector_hero' );

$vector_hero_title = $vector_hero['vector_hero_title'];
$vector_hero_copy = $vector_hero['vector_hero_copy'];
$vector_hero_image = $vector_hero['vector_hero_image'];

$vector_image_banner = get_field('vector_banner_image');
$vector_image_banner_2 = get_field('vector_banner_image_2');
?>

<?php if($vector_hero) : ?>
<div class="vector-hero">
    <div class="vector-hero-content">
        <?php if($vector_hero_title) : ?>
            <h1 class="vector-hero-content-title heading-purple"><?php echo $vector_hero_title; ?></h1>
        <?php endif; ?>
       ...
       <?php } ?>
        ...
        <?php if($vector_hero_copy) :  ?>
            <div class="vector-hero-copy">
                <?php echo wp_kses_post($vector_hero_copy); ?>
            </div>
        <?php endif; ?>

    </div>
    <?php if( $vector_hero_image ) : ?>
    <div class="vector-hero-image">
        <img src="<?php echo $vector_hero_image['url']  ?>" />
    </div>
    <?php endif; ?>
</div>
<?php endif; ?>

<?php if ($vector_image_banner) : ?>
    <div class="vector-image-banner">
        <img class="vector-image" src="<?php echo $vector_image_banner['url'] ?>" />
    </div>
<?php endif; ?>
...
<?php if ($vector_image_banner_2) : ?>
    <div class="vector-image-banner vector-image-2">
        <img class="vector-image " src="<?php echo $vector_image_banner_2['url'] ?>" />
    </div>
<?php endif; ?>
